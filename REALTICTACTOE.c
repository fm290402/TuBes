...
int main()
{
	...
	if(input==1){
		...
		about();
		printf("\n\n\t Tekan 9 apapun untuk kembali ke menu : ");
		scanf("%d", &input1);
		if(input1==9){
		main();
		}
...
char check_5X5()
{
	int i,j;
        ...
        if(matrix[0][0]==matrix[1][0]&&matrix[1][0]==matrix[2][0])
			return matrix[0][0];
		if(matrix[1][0]==matrix[2][0]&&matrix[2][0]==matrix[3][0])
			return matrix[1][0];
		if(matrix[2][0]==matrix[3][0]&&matrix[3][0]==matrix[4][0])
			return matrix[2][0];
		if(matrix[0][1]==matrix[1][1]&&matrix[1][1]==matrix[2][1])
			return matrix[0][1];
		if(matrix[1][1]==matrix[2][1]&&matrix[2][1]==matrix[3][1])
			return matrix[1][1];
		if(matrix[2][1]==matrix[3][1]&&matrix[3][1]==matrix[4][1])
			return matrix[2][1];
		if(matrix[0][2]==matrix[1][2]&&matrix[1][2]==matrix[2][2])
			return matrix[0][2];
		if(matrix[1][2]==matrix[2][2]&&matrix[2][2]==matrix[3][2])
			return matrix[1][2];
		if(matrix[2][2]==matrix[3][2]&&matrix[3][2]==matrix[4][2])
			return matrix[2][2];
		if(matrix[0][3]==matrix[1][3]&&matrix[1][3]==matrix[2][3])
			return matrix[0][3];
		if(matrix[1][3]==matrix[2][3]&&matrix[2][3]==matrix[3][3])
			return matrix[1][3];
		if(matrix[2][3]==matrix[3][3]&&matrix[3][3]==matrix[4][3])
			return matrix[2][3];
		if(matrix[0][4]==matrix[1][4]&&matrix[1][4]==matrix[2][4])
			return matrix[0][4];
		if(matrix[1][4]==matrix[2][4]&&matrix[2][4]==matrix[3][4])
			return matrix[1][4];
		if(matrix[2][4]==matrix[3][4]&&matrix[3][4]==matrix[4][4])
			return matrix[2][4];
        ...
        if(matrix[0][0]==matrix[0][1]&&matrix[0][1]==matrix[0][2])
			return matrix[0][0];
		if(matrix[0][1]==matrix[0][2]&&matrix[0][2]==matrix[0][3])
			return matrix[0][1];
		if(matrix[0][2]==matrix[0][3]&&matrix[0][3]==matrix[0][4])
			return matrix[0][2];
		if(matrix[1][0]==matrix[1][1]&&matrix[1][1]==matrix[1][2])
			return matrix[1][0];
		if(matrix[1][1]==matrix[1][2]&&matrix[1][2]==matrix[1][3])
			return matrix[1][1];
		if(matrix[1][2]==matrix[1][3]&&matrix[1][3]==matrix[1][4])
			return matrix[1][2];
		if(matrix[2][0]==matrix[2][1]&&matrix[2][1]==matrix[2][2])
			return matrix[2][0];
		if(matrix[2][1]==matrix[2][2]&&matrix[2][2]==matrix[2][3])
			return matrix[2][1];
		if(matrix[2][2]==matrix[2][3]&&matrix[2][3]==matrix[2][4])
			return matrix[2][2];
		if(matrix[3][0]==matrix[3][1]&&matrix[3][1]==matrix[3][2])
			return matrix[3][0];
		if(matrix[3][1]==matrix[3][2]&&matrix[3][2]==matrix[3][3])
			return matrix[3][1];
		if(matrix[3][2]==matrix[3][3]&&matrix[3][3]==matrix[3][4])
			return matrix[3][2];
		if(matrix[4][0]==matrix[4][1]&&matrix[4][1]==matrix[4][2])
			return matrix[4][0];
		if(matrix[4][1]==matrix[4][2]&&matrix[4][2]==matrix[4][3])
			return matrix[4][1];
		if(matrix[4][2]==matrix[4][3]&&matrix[4][3]==matrix[4][4])
			return matrix[4][2];
        ...
        if(matrix[2][0]==matrix[1][1]&&matrix[1][1]==matrix[0][2])
            return matrix[2][0];
        if(matrix[1][0]==matrix[2][1]&&matrix[2][1]==matrix[3][2])
            return matrix[1][0];
        if(matrix[3][0]==matrix[2][1]&&matrix[2][1]==matrix[1][2])
            return matrix[3][0];
        if(matrix[2][0]==matrix[3][1]&&matrix[3][1]==matrix[4][2])
            return matrix[2][0];
        if(matrix[4][0]==matrix[3][1]&&matrix[3][1]==matrix[2][2])
            return matrix[4][0];
        if(matrix[0][1]==matrix[1][2]&&matrix[1][2]==matrix[2][3])
            return matrix[0][1];
        if(matrix[2][1]==matrix[1][2]&&matrix[1][2]==matrix[0][3])
            return matrix[2][1];
        if(matrix[1][1]==matrix[2][2]&&matrix[2][2]==matrix[3][3])
            return matrix[1][1];
        if(matrix[3][1]==matrix[2][2]&&matrix[2][2]==matrix[1][3])
            return matrix[3][1];
        if(matrix[2][1]==matrix[3][2]&&matrix[3][2]==matrix[4][3])
            return matrix[2][1];
        if(matrix[4][1]==matrix[3][2]&&matrix[3][2]==matrix[2][3])
            return matrix[4][1];
        if(matrix[0][2]==matrix[1][3]&&matrix[1][3]==matrix[2][4])
            return matrix[0][2];
        if(matrix[2][2]==matrix[1][3]&&matrix[1][3]==matrix[0][4])
            return matrix[2][2];
        if(matrix[1][2]==matrix[2][3]&&matrix[2][3]==matrix[3][4])
            return matrix[1][2];
        if(matrix[3][2]==matrix[2][3]&&matrix[2][3]==matrix[1][4])
            return matrix[3][2];
        if(matrix[2][2]==matrix[3][3]&&matrix[3][3]==matrix[4][4])
            return matrix[2][2];
        if(matrix[4][2]==matrix[3][3]&&matrix[3][3]==matrix[2][4])
            return matrix[4][2];

        // Jika tidak ada baris,kolom, atau diagonal yang memenuhi, maka cek bila ada papan kosong
        ...
        // Jika tidak ada baris, kolom, diagonal, atau papan kosong, maka permainan draw
